...
2) если таблиц несколько — опиши найденные ключи и покрытие, но не считай таблицы уже объединёнными;
3) основная область / ядро категорий (города, сегменты) и что в неё не входит;
4) выбросы, аномалии, подозрительные шкалы и валюты;
5) различия групп и производные метрики;
6) по важным столбцам — по одному выводу.
